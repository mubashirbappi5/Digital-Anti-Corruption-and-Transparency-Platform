  ...
  const projects = [
    {
      ...
      progress: 70,
      description:
        "Verifying the transparency of budget allocation and expense reports.",
    },
    {
      id: "PRJ002",
      ...
      progress: 100,
      description:
        "Investigated and recovered misused public funds for healthcare services.",
    },
    {
      id: "PRJ003",
      ...
      progress: 30,
      description:
        "Awaiting legal review on unauthorized property acquisitions.",
    },
  ];
    ...
    <section className="py-16 bg-blue-50 dark:bg-gray-900">
      <div className="max-w-6xl mx-auto px-6">
        ...
        <p className="text-center text-gray-700 dark:text-gray-300 mt-4">
          Stay informed about ongoing investigations and anti-corruption
          projects.
        </p>
