...
const Contact = () => {
	...
	<div className="flex flex-col justify-between">
		<div className="space-y-2">
			...
			<div className="dark:text-gray-600">Have questions or need assistance? Reach out to us</div>
		</div>
		<img src="https://i.ibb.co.com/T26DL1X/Mobile-user-rafiki.png" alt="" className="p-6 w-52 md:w-64" />
	</div>
