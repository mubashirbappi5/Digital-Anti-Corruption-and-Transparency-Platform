    ...
    <div>
      <footer className="bg-white dark:bg-gray-900 mt-10">
        <div className="container p-6 mx-auto">
          <div className="lg:flex">
            ...
            <div className="mt-6 lg:mt-0 lg:flex-1">
              <div className="grid grid-cols-2 gap-6 sm:grid-cols-3 md:grid-cols-4">
                <div>
                  <h3 className="text-gray-700 uppercase dark:text-white font-bold">
                    About
                  </h3>
                  <a
                    href="#"
          ...
          <div>
            <p className="text-center font-light text-black dark:text-gray-400">
              © All rights reserved by Transparent BD 2025.
            </p>
          </div>
        </div>
      </footer>
